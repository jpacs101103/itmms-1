...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="assets/images/logo/itmms.png" type="image/x-icon">
        <link rel="icon" href="assets/images/logo/itmms.png" type="image/x-icon">
        <?php
            if($controller != 'report') {
                echo '<title>itmms | ' . ($controller === 'itmms' ? preg_replace('/[^a-zA-Z0-9]/', ' ', ucwords($method)) : preg_replace('/[^a-zA-Z0-9]/', ' ', ucwords($controller))) . '</title>';
            }
