...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default" id="hardware-table">
            <div class="panel-heading">
                <i class="fa fa-list-alt"></i> <b>Hardware Reports</b>
                <span class="pull-right visible-lg">
                    <button type="button" class="btn btn-xs btn-default fullscreen-hr" title="Toogle Fullscreen">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    <table class="table table-hover table-bordered width100 text-break display responsive nowrap" id="hardware-report">
                        <thead>
                            <tr>
