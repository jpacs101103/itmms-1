            ...
            <div class="col-lg-8 col-centered bordered">
                <form class="horizontal-form" method="POST" role="form">
                    <table class="itmms-table">
                        ...
                        <tr>
                            <td><legend class="padding10 itmms-title">User Information</legend></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-12 itmms-label">First Name:</div>
                                    <div class="col-lg-12">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-12 itmms-label">Last Name:</div>
                                    <div class="col-lg-12">
            ...
            <div class="col-lg-8 col-centered bordered">
                <form class="horizontal-form" method="POST" role="form">
                    <table class="itmms-table">
                        <input type="hidden" name="id" value="<?php echo $sess_id ?>">
                        <tr>
                            <td><legend class="padding10 itmms-title">Password Settings</legend></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-12 itmms-label">Current Password:</div>
                                    <div class="col-lg-12">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-12 itmms-label">New Password:</div>
                                    <div class="col-lg-12">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-12 itmms-label">Confirm Password:</div>
                                    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-8 col-centered bordered">
                <form class="horizontal-form" method="POST" role="form">
                    <table class="itmms-table">
                        <tr>
                            <td><legend class="padding10 itmms-title">Activity Logs</legend></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="row">
        ...
        <div class="row">
            <div class="col-lg-8 col-centered bordered">
                <form class="horizontal-form" method="POST" role="form">
                    <table class="itmms-table">
                        <tr>
                            <td><legend class="padding10 itmms-title">Access Rights Settings</legend></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="form-group">
                                <div class="col-sm-12 itmms-label">Select User:</div>
                                    <div class="col-lg-12">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-12 itmms-label">Privileges:</div>
                                    <div class="col-lg-12">
