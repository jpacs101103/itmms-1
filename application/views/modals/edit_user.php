    ...
    <form method="post">
        <div class="modal-body form-horizontal">
            <div class="form-group">
                <div class="col-sm-12 itmms-label">Employee ID:<i class="fa fa-lock fg-gray pull-right padding-right5"></i></div>
                <div class="col-sm-12">
            ...
            <div class="form-group">
                <div class="col-sm-6 itmms-label">First Name:</div>
                <div class="col-sm-6 itmms-label visible-lg">Last Name:</div>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="firstname" id="firstname" placeholder="Input First Name">
                </div>
                <div class="col-lg-12 itmms-label-hidden-lg hidden-lg">Last Name:</div>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <span class="col-sm-12 itmms-label">Department:</span>
                <div class="col-lg-12">
