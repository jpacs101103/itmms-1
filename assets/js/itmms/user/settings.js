$( function( $ ) {
    ...
    obj.ajax_clear_activity_logs = function( $small_modal ) {
        ...
        $.ajax({
            ...
            success : function( result ) {
                if( result.status ) {
                    obj.activity_logs.ajax.reload();
                    toastr.success( 'Cleared!', "itmms | Activity Logs" );

                    $small_modal.modal( 'hide' );
                }
                else {
                    toastr.error( 'Unable to delete', " itmms | Activity Logs" );
                }
            },
    ...
    obj.ajax_update_access = function ( $form ){
        ...
        $.ajax( {
            ...
            success : function( result ) {
                if(result.status) {
                    toastr.success('User access Updated!', "itmms | Settings");
                }
                else {
                    toastr.error( "Nothing to update", "itmms | Settings");
                }
                $form.trigger("reset");
        ...
        $.ajax( {
            ...
            success : function( result ) {
                if(result.status) {
                    ...
                    toastr.success('User Info Updated!', "itmms | Settings");
                }
                else {
                    toastr.error( "Nothing to update", "itmms | Settings");
                }
    ...
    obj.ajax_update_password = function ( $form ){
        ...
        $.ajax( {
            ...
            success : function( result ) {
                if(result.status) {
                    toastr.success('Password changed!', "itmms | Settings");
                }
                else {
                    toastr.error( "Nothing to update", "itmms | Settings");
                }
