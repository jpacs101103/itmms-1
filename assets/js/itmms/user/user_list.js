    ...
    obj.ajax_enabled_user_by_id = function( $small_modal ) {
        $.ajax({
            ...
            success : function( result ){
                if( result.status ) {
                    obj.user_list.ajax.reload();
                    toastr.success( 'Enabled!', "itmms | User" );

                    $small_modal.modal( 'hide' );
                }
                else {
                    toastr.error( 'Unable to enabled', " itmms | User" );
                }
            },
            error : function( xhr, status ) {
                alert( xhr.responseText );
    ...
    obj.ajax_disabled_user_by_id = function( $small_modal ) {
        $.ajax({
            ...
            success : function( result ){
                if( result.status ) {
                    obj.user_list.ajax.reload();
                    toastr.success( 'Disabled!', "itmms | User" );

                    $small_modal.modal( 'hide' );
                }
                else {
                    toastr.error( 'Unable to disabled', " itmms | User" );
                }
            },
            error : function( xhr, status ) {
                alert( xhr.responseText );
    ...
    obj.ajax_promote_user_by_id = function( $small_modal ) {
        $.ajax({
            ...
            success : function( result ){
                if( result.status ) {
                    obj.user_list.ajax.reload();
                    toastr.success( 'Sucessfully Promoted!', "itmms | User" );
    ...
    obj.ajax_demote_user_by_id = function( $small_modal ) {
        $.ajax({
            ...
            success : function( result ){
                if( result.status ) {
                    obj.user_list.ajax.reload();
                    toastr.success( 'Sucessfully Demoted!', "itmms | User" );
    ...
    obj.ajax_update_user = function ( $form, $modal ){
        ...
        $.ajax( {
            ...
            success : function( result ) {
                if(result.status){
                    obj.user_list.ajax.reload();
                    toastr.success('Sucessfully updated User!', "itmms | User");

                    $modal.modal( 'hide' );
                }
                else{
                    toastr.error( "Nothing to update", "itmms | User" );
                }
    ...
    obj.ajax_reset_user_pass = function (user_id) {
        $.ajax( {
            ...
            success : function( result ) {
                if(result.status){
                    obj.user_list.ajax.reload();
                    toastr.success('Password has been reset to <b>123456</b>', "itmms | User");

                }
                else{
                    toastr.error( "Unable to reset user password", "itmms | User" );
                }
