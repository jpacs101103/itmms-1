        ...
        $.ajax( {
            ...
            success : function( result ) {
                if(result.status){
                    ...
                    toastr.success( "Profile updated successfully", "itmms | User Profile" );
                }
                else{
                    toastr.error( "Failed to update", "itmms | User Profile" );
                }
    ...
    function validate( $form, $modal ){
        if( $.fn.fileinput() ) {
            $("#avatar").fileinput({
                ...
                showUpload: false,
                initialPreview: [
                   '<img src="' + $('.user-info > img').attr('src') + '" class="file-preview-avatar" alt="Upload Your Picture">'
                ],
                defaultPreviewContent: '<img src="' + $('.media-avatar > img').attr('src') + '" class="file-preview-avatar" alt="Upload Your Picture">',
