    ...
    obj.ajax_mark_replaced_service_order_by_id = function( $small_modal ){
        ...
        $.ajax({
            ...
            success : function( result ){
                ...
                {
                    obj.user_rof_pending_list.ajax.reload();
                    toastr.success( 'Marked as Replaced!', "itmms | Service Order" );

                    $small_modal.modal( 'hide' );
                }
                else
                {
                    toastr.error( 'Unable to mark as Replaced', " itmms | Service Order" );
                }
            },
    ...
    obj.ajax_mark_for_ordering_service_order_by_id = function( $small_modal ){
        ...
        $.ajax({
            ...
            success : function( result ){
                ...
                {
                    obj.user_rof_pending_list.ajax.reload();
                    toastr.success( 'Marked as for Ordering!', "itmms | Service Order" );

                    $small_modal.modal( 'hide' );
                }
                else
                {
                    toastr.error( 'Unable to process', " itmms | Service Order" );
                }
            },
            error : function( xhr, status ){
                alert( xhr.responseText );
