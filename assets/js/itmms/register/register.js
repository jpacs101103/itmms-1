            ...
            success : function( result ) {
                if(result.status){
                    if(result.access_rights == 'add')
                        toastr.success( "Added!", "itmms | User" );
                    else
                        toastr.success( "Added! <a role='button' class='btn btn-sm-toastr' href='manage/users'><i class='fa fa-external-link'></i> View List</a>", "itmms | User" );
                }
                else{
                    toastr.error( "Failed to add", "itmms | User" );
                }
