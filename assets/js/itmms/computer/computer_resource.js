            ...
            success : function( result ) {
                if(result.status){
                    if(result.access_rights == 'add')
                        toastr.success( "Added!", "itmms | Resource" );
                    else
                        toastr.success( "Added! <a role='button' class='btn btn-sm-toastr' href='manage/resources'><i class='fa fa-external-link'></i> View List</a>", "itmms | Resource" );
                }
                else{
                    toastr.error( "Failed to add", "itmms | Resource" );
                }
